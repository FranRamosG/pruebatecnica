...
A pesar de contar con escasos conocimientos sobre las herramientas necesarias al inicio del proyecto, percibí esta iniciativa como un desafío valioso para ampliar mis habilidades y comprensión en el área. Aunque no logré llevarlo a cabo en su totalidad, estoy convencido de que he adquirido más conocimientos de los que hubiera alcanzado sin este proyecto, generando un impulso adicional para continuar aprendiendo.
...
Dada mi limitada experiencia en las herramientas necesarias para llevar a cabo esta prueba, mi enfoque inicial consistió en adquirir conocimientos sobre Terraform, GCP y AWS. La selección de GCP como la plataforma para implementar la infraestructura en la nube se basó principalmente en mi familiaridad previa con el entorno de Google.

Posterior a este punto, me centré en la búsqueda de cómo comenzar el proyecto, identificando en la página oficial de Terraform un tutorial específico que guía la creación de una infraestructura básica con una instancia en GCP:

[![image](https://github.com/FranRamosG/pruebatecnica/assets/131311475/74251376-c86f-429b-9c9f-8972ba10b368)
](https://developer.hashicorp.com/terraform/tutorials/gcp-get-started)

Realizando este tutorial es como aprendí para usar los siguientes archivos:
...
Tras esto, comencé a buscar formas de crear un balanceador de cargas, cuando encontré la siguiente imagen:
...
Con la que empecé a entender cómo funcionaba el balanceador de cargas y con un poco de ayuda de las IA para conocer los elementos de la infraestructura necesarios para cada parte del balanceador y buscando en la documentación oficial de Terraform cómo funciona:
...
Ante esto, comencé a buscar en internet para encontrar métodos efectivos de implementar un balanceador de cargas. Finalmente, encontré una breve guía en la página oficial de GCP que utilicé como referencia para establecer la infraestructura necesaria:
...
Esta sección especifica la versión de Terraform y el proveedor de GCP que se utilizará. Además, configura las credenciales y la información del proyecto, región y zona para la interacción con GCP. 
Los atributos del proveedor como son los nombrados anteriormente han sido guardados en dos archivos de variables  [variables.tf](https://github.com/FranRamosG/pruebatecnica/blob/main/variables.tf) y [terraform.tfvars](https://github.com/FranRamosG/pruebatecnica/blob/main/terraform.tfvars) como se ha explicado en el proceso.
